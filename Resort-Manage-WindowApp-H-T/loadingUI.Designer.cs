namespace Resort_Manage_WindowApp_H_T
{
    partial class loadingUI
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.TabIndex = 0;
            label1.Text = "Đang tải giao diện";
            // 
            // label2
            // 
            label2.AutoSize = true;
            label2.Font = new Font("Poppins", 21.75F, FontStyle.Bold, GraphicsUnit.Point);
            label2.ForeColor = Color.Black;
            label2.Location = new Point(169, 123);
            label2.Name = "label2";
            label2.Size = new Size(212, 51);
            label2.TabIndex = 0;
            label2.Text = "Trung Resort";
            // 
            // pictureBox1
            // 
            pictureBox1.Image = (Image)resources.GetObject("pictureBox1.Image");
            pictureBox1.Location = new Point(63, 97);
            ...
            pictureBox3.Location = new Point(411, 97);
            pictureBox3.Name = "pictureBox3";
            pictureBox3.Size = new Size(300, 250);
